  ...
  switch(protocol) {
    case 1:
      ...
      Serial.println((String)zumoBot.lineSensorValues[0] + "\t" + (String)zumoBot.lineSensorValues[1] + "\t" + 
                     (String)zumoBot.lineSensorValues[2] + "\t" + (String)zumoBot.lineSensorValues[3] + "\t" + 
                     (String)zumoBot.lineSensorValues[4]);
      zumoBot.displayPrint((String)zumoBot.lineSensorValues[1], true);
      zumoBot.displayPrint((String)zumoBot.lineSensorValues[3]);
      delay(100);
      break;
    case 2:
    ...
    case 3:
      ...
      Serial.println("PROXY: " + (String)zumoBot.proximitySensorValues[0] + "\t" + zumoBot.proximitySensorValues[1] + "\t" + 
